...
public class CustomerController {
    ...
    @PutMapping("/{id}")
    public CustomerResponseDTO update(@PathVariable Integer id,@Valid @RequestBody CustomerRequestDTO dto) {

        return customerService.update(id, dto);
    }

    @PatchMapping("/{id}")
    public CustomerResponseDTO patch(@PathVariable Integer id, @RequestBody CustomerRequestDTO dto) {
